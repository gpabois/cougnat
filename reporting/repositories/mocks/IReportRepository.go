...
func (_m *IReportRepository) Create(report reporting_models.Report) result.Result[int] {
	ret := _m.Called(report)

	var r0 result.Result[int]
	if rf, ok := ret.Get(0).(func(reporting_models.Report) result.Result[int]); ok {
		r0 = rf(report)
	} else {
...
func (_c *IReportRepository_Create_Call) Run(run func(report reporting_models.Report)) *IReportRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(reporting_models.Report))
	})
	return _c
}
...
func (_c *IReportRepository_Create_Call) RunAndReturn(run func(reporting_models.Report) result.Result[int]) *IReportRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
